...
create table `cuota`(
  ...
  `idPrestamo` int(11) NOT NULL,
   ...
   CONSTRAINT `fkidPrestamo` FOREIGN KEY (`idPrestamo`) REFERENCES `prestamo` (`idPrestamo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
SELECT * FROM `bd-hibernate-uno-a-muchos`.prestamo;
SELECT * FROM `bd-hibernate-uno-a-muchos`.cuota;
